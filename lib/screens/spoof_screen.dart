...
class _SpoofScreenState extends State<SpoofScreen> {
              ...
              child: Column(
                children: [
                  GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: isEnabled ? color.withOpacity(0.35) : Colors.white.withOpacity(0.06)),
                        boxShadow: isEnabled ? [BoxShadow(color: color.withOpacity(0.12), blurRadius: 16)] : [],
                      ),
                      child: Row(
                        children: [
                          ...
                          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Text(t['desc'] as String, style: TextStyle(fontSize: 10, color: Colors.white.withOpacity(0.3))),
                          ])),
                          GestureDetector(
                            ...
                            child: AnimatedContainer(
                              duration: const Duration(milliseconds: 250),
                              width: 42, height: 24,
                              decoration: BoxDecoration(color: isEnabled ? color : Colors.white.withOpacity(0.1), borderRadius: BorderRadius.circular(99)),
                          ...
                          AnimatedRotation(turns: isExpanded ? 0.5 : 0, duration: const Duration(milliseconds: 200), child: Icon(Icons.keyboard_arrow_down, color: Colors.white.withOpacity(0.3), size: 18)),
                        ],
                      ),
                    ),
                  ),
                  if (isExpanded)
                    Container(
                      padding: const EdgeInsets.all(14),
                      decoration: BoxDecoration(color: Colors.white.withOpacity(0.02), borderRadius: const BorderRadius.only(bottomLeft: Radius.circular(14), bottomRight: Radius.circular(14)), border: Border.all(color: Colors.white.withOpacity(0.06))),
  ...
  Widget _presetWidget(String id, Color color) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Select device preset:', style: TextStyle(fontSize: 11, color: Colors.white.withOpacity(0.3))),
        ...
        ..._devices.map((d) => GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(color: _selectedDevice[id] == d ? color.withOpacity(0.15) : Colors.white.withOpacity(0.03), borderRadius: BorderRadius.circular(10), border: Border.all(color: _selectedDevice[id] == d ? color.withOpacity(0.4) : Colors.white.withOpacity(0.06))),
            child: Text(d, style: TextStyle(fontSize: 12, color: _selectedDevice[id] == d ? color : Colors.white.withOpacity(0.55), fontWeight: _selectedDevice[id] == d ? FontWeight.w600 : FontWeight.w400)),
          ),
        )),
      ],
    );
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: Container(width: double.infinity, padding: const EdgeInsets.symmetric(vertical: 10), decoration: BoxDecoration(color: color.withOpacity(0.15), borderRadius: BorderRadius.circular(10), border: Border.all(color: color.withOpacity(0.35))), child: Text('Apply Custom Props', textAlign: TextAlign.center, style: TextStyle(fontSize: 12, color: color, fontWeight: FontWeight.w700))),
        ),
      ],
    );
  }
