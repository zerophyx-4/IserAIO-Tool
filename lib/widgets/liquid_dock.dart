  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: Colors.black.withOpacity(0.5), blurRadius: 32),
          BoxShadow(color: theme.accent.withOpacity(0.15), blurRadius: 20),
        ],
      ),
      child: Row(
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: isActive ? BoxDecoration(
                gradient: LinearGradient(colors: [theme.accent.withOpacity(0.2), theme.accent.withOpacity(0.1)]),
                borderRadius: BorderRadius.circular(99),
                border: Border.all(color: theme.accentBorder),
                boxShadow: [BoxShadow(color: theme.accent.withOpacity(0.2), blurRadius: 16)],
              ) : null,
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Icon(tab.icon, size: 20, color: isActive ? Colors.white : Colors.white.withOpacity(0.28)),
                  if (isActive) ...[
